...
let database = [
	...
	},
	{
		...
		"plot": "Gandhi's movie is fully explained as a man of nonviolence. Through his patience, he is able to drive the British out of the subcontinent. And the stubborn nature of Jinnah and his commitment towards Pakistan is portrayed.",
	...
	},
	{
		...
		"plot": "In the dead of a Wyoming winter, a bounty hunter and his prisoner find shelter in a cabin currently inhabited by a collection of nefarious movies.",
...
const removeMovie = (id) => {
	database = database.filter((movie) => movie.id !== Number(id));
